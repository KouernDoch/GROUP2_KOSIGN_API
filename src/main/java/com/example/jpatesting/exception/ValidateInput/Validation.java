package com.example.jpatesting.exception.ValidateInput;

import com.example.jpatesting.exception.FieldBlankExceptionHandler;
...
//       throw new FieldBlankExceptionHandler("UserName cannot allow input with whiteSpace. Ex: doch_kouern or doch@kouern");
//    }
...
//        String username="^(?!.*[ ]{2,})[\\w@][-@\\w]{0,80}$";
//        Pattern pattern2=Pattern.compile(username);
//        Matcher matcher2=pattern2.matcher(inputUserName);
//        if (!matcher2.matches()){
//            throw new FieldBlankExceptionHandler(("username must be text and should be used special characters only with `_`,`@`"));
//        }
